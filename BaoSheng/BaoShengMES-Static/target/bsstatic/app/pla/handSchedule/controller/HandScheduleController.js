...
//				me.updateSpecialFlag('确认库存生产？', '3', true); // 更新订单特殊状态 : 3:库存生产
	...
	finishedProductEdit : function(){
		...
		/*var productForm = grid.query('form')[0];
		var uselength = Number(form.getForm().getValues().uselength)+Number(productForm.getForm().getValues().uselength);
		productForm.getForm().setValues({
			uselength : uselength
		});*/
